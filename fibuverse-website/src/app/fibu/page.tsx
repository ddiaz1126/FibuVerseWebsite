...
return (
    <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
      ...
      <button
        ...
        className="w-full flex items-center justify-between p-2.5 hover:bg-gray-750 transition-colors"
      >
        <div className="flex items-center gap-1.5">
          <div className="text-xs font-semibold">Agent Network</div>
          <div className="text-[9px] text-gray-400 bg-gray-700 px-1 py-0.5 rounded">
