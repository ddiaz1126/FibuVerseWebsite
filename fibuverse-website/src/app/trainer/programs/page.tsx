  ...
  return (
    <div className="flex h-screen bg-gray-900 text-white">
      ...
      <div className="w-64 border-r border-gray-800 flex flex-col">
        {/* Tabs */}
        <div className="flex">
          <button className="flex-1 p-3 border-b border-gray-800 hover:bg-gray-800">
            Workouts
          </button>
          <button className="flex-1 p-3 border-b border-gray-800 hover:bg-gray-800">
            Programs
      ...
      <div className="flex-1 border-r border-gray-800 p-6 overflow-y-auto">
        ...
        <div className="p-4 border-b border-gray-800">
            ...
            {days.map((day) => {
                ...
                const isWorkoutDay = isSameDay(day, workoutDate); // new state for colored dot
                return (
                <div
                    key={day.toISOString()}
    ...
    <div className="flex-1 p-4 flex flex-col gap-4">
        ...
        >
            {["General", "Strength", "Hypertrophy", "Powerlifting", "HIIT"].map((type) => (
